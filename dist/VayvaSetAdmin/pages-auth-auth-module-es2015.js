...
const routes = [
    {
        ...
        children: [
            {
                path: 'login',
                loadChildren: () => __webpack_require__.e(/*! import() | login-basic-login-basic-login-module */ "login-basic-login-basic-login-module").then(__webpack_require__.bind(null, /*! ./login/basic-login/basic-login.module */ "./src/app/pages/auth/login/basic-login/basic-login.module.ts")).then(m => m.BasicLoginModule)
            },
            {
                path: 'registration',
